...
<link rel="stylesheet" href="csscode/Sign_UP.css">
</head>
<body>
...
<b>Address</b><input type="text" placeholder="Enter Address" name="address">
<b>Email</b><input type="text" placeholder="Enter Email ID" name="Email">
