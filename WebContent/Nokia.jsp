...
@keyframes slider
{
 0%
 {
      background-image:url('images/Nokia-C20.jpg');
 }
 35%
 {
      background-image:url('images/Nokia1.jpg');
 }
 75%
 {
    background-image: url('images/Nokia2.jpg');
 }
}
...
<h3>Model Name:Nokia C20 </h3>
<h3>Original Price:20,000</h3>
<h3> Sale Price:19,8903</h3>
